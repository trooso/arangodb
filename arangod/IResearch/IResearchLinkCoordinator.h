...
class IResearchLinkCoordinator final : public arangodb::ClusterIndex, public IResearchLink {
 public:
  ...
  size_t memory() const final {
    return 0;  // FIXME return in memory size
  }
  ...
  class IndexFactory final : public IndexTypeFactory {
   ...
   public:
    ...
    Result normalize(velocypack::Builder& normalized, velocypack::Slice definition,
                     bool isCreation, TRI_vocbase_t const& vocbase) const final;
  };
